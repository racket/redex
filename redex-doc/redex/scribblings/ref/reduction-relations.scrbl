...
@racketblock[
(define r2 (compatible-closure r X x))
...
@racketblock[
(define r3 (compatible-closure r2 X y))
...
@racketblock[
(define-extended-language Y X
  [ C ::= (hole * x) (x * hole) ]
  )

(define r4 (context-closure r2 Y C))
